...
class regionTable extends Table {
  function regionTable() {
    ...
    $this->addColumn('uri','varchar',32,0,0,'<span class="required">URI*</span>',array('source'=>'region','apply_funct_js'=>'friendly_url'));
...
class imagenTable extends Table {
  function imagenTable() {
    ...
    $this->addColumn('imagen','image',0,0,0,'Imagen',array('sizes'=>'640x200x1,640x300x1,600x400,397x200x1,300x100x1,360x122x1,271x165x1,270x280x1,397x122x1,288x318,232x155,150x100x1,138x90,120x90x1,150x150x1,77x77x1,53x82x1,48x48x1,1024x1024'));
    #$this->addColumn('imagen','image',0,0,0,'Imagen',array('sizes'=>'397x200'));
    $this->addColumn('credito','varchar',500,0,0,'Credito');
    $this->addColumn('claves','varchar',255,0,0,'Etiquetas',array('autocomplete'=>true,'autocomplete_tb'=>'clave'));
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('cdn','auto',0,0,0,'CDN?');
    $this->addColumn('idedicion','auto',0,0,'edicion','Edición',array('default'=>$_SESSION['edicion']['idedicion']));
...
class comentariogaleriaTable extends Table {
  function comentariogaleriaTable() {
    ...
    #$this->addColumn('idgaleria','int',0,0,'galeria','Galeria',array('readonly'=>true));
    ...
    $this->addColumn('ip','auto',0,0,0,'IP',array('default'=>$_SERVER['REMOTE_ADDR']));
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
  } 
}

// De momento para las caricaturas
class comentariocaricaturaTable extends Table {
  function comentariocaricaturaTable() {
    ...
    $this->addColumn('idcaricatura','int',0,0,'caricatura','Caricatura',array('readonly'=>true));
    $this->addColumn('nombre','varchar',50,0,0,'Nombre');
    $this->addColumn('email','varchar',50,0,0,'Email');
    $this->addColumn('web','varchar',300,0,0,'Página Web');
    $this->addColumn('comentariocaricatura','text',0,0,0,'Texto');
    $this->addColumn('estado','char',1,0,0,'Estado',array('arr_values'=>array('P'=>'en Revisión','B'=>'Bloqueado','A'=>'Aprobado')));
    $this->addColumn('idusuario','int',0,0,'usuario','Usuario',array('readonly'=>true));
    $this->addColumn('ip','auto',0,0,0,'IP',array('default'=>$_SERVER['REMOTE_ADDR']));
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
  }
...
class videoTable extends Table {
  function videoTable() {
    ...
    #$this->addColumn('preview','image',0,0,0,'<span class="required">Preview</span>',array('sizes'=>'120x90,232x155'));
    $this->addColumn('claves','varchar',255,0,0,'Etiquetas',array('autocomplete'=>true,'autocomplete_tb'=>'clave'));
    $this->addColumn('cdn','auto',0,0,0,'CDN?');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'usuario'));
...
class comentariovideoTable extends Table {
  function comentariovideoTable() {
    ...
    $this->addColumn('idvideo','int',0,0,'video','Video',array('readonly'=>true));
    $this->addColumn('nombre','varchar',50,0,0,'Nombre');
    $this->addColumn('email','varchar',50,0,0,'Email');
    $this->addColumn('web','varchar',300,0,0,'Página Web');
...
class suplementoTable extends Table {
  function suplementoTable() {
    ...
    $this->addColumn('uri','varchar',32,0,0,'<span class="required">URI</span>',array('source'=>'suplemento','apply_funct_js'=>'friendly_url'));
...
class seccionsuplementoTable extends Table {
  function seccionsuplementoTable() {
    ...
    $this->addColumn('uri','varchar',32,1,0,'<span class="required">Id/URI*</span>',array('source'=>'seccionsuplemento','apply_funct_js'=>'friendly_url'));
    $this->addColumn('activo','bool',0,0,0,'Activo?');
    $this->addColumn('orden','order',0,0,0,'Orden');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'na_usuario.usuario'));
    $this->addColumn('na_usuario.nombre','external');
    $this->addColumn('na_usuario.apellido','external');
  }
}
...
class edicionsuplementoTable extends Table {
  function edicionsuplementoTable() {
    ...
    $this->addColumn('portadasuplemento','image',0,0,0,'Portada',array('sizes'=>'270,150x150x1,250,150x174x1,270x280x1'));
...
class articuloTable extends Table {
  function articuloTable() {
    ...
    $this->key = 'idarticulo';
    $this->maxrows = 10;
    $this->cache = array(strftime("%Y|%m|%d",strtotime($_SESSION['edicion']['edicion'])) . '|suplemento|[uri]|portada', strftime("%Y|%m|%d",strtotime($_SESSION['edicion']['edicion'])) . '|suplemento|[uri]|');
    ...
    $this->addColumn('texto','xhtml',0,0,0,'<span class="required">Texto*</span>',array('style'=>'width:600px;height:300px;'));
    $this->addColumn('claves','varchar',255,0,0,'Etiquetas',array('autocomplete'=>true,'autocomplete_tb'=>'clave'));
    $this->addColumn('estado','varchar',1,0,0,'Estado',array('arr_values'=>array('A'=>'Publicad@','D'=>'Borrador','P'=>'Pendiente a Revisión')));
    $this->addColumn('ubicacion','char',1,0,0,'Ubicacion',array('arr_values'=>array('D'=>'Derecha','I'=>'Izquierda')));
    $this->addColumn('orden','int',0,0,0,'Orden');
    ...
    #$this->addColumn('(SELECT round((((raiting_1+(raiting_2*2)+(raiting_3*3)+(raiting_4*4)+(raiting_5*5))::float)/(raiting_1+raiting_2+raiting_3+raiting_4+raiting_5))::numeric,1) AS stars)','external');
  }
}
...
class comentarioarticuloTable extends Table {
  function comentarioarticuloTable() {
    ...
    $this->addColumn('idarticulo','int',0,0,'articulo','Articulo');
    #$this->addColumn('idarticulo','int',0,0,'articulo','Articulo',array('readonly'=>true));
    $this->addColumn('nombre','varchar',50,0,0,'Nombre');
    $this->addColumn('email','varchar',50,0,0,'Email');
    $this->addColumn('web','varchar',300,0,0,'Página Web');
#    $this->addColumn('comentarioarticulo','text',0,0,0,'Texto');
...
class especialTable extends Table {
  function especialTable() {
    ...
    $this->addColumn('uri','varchar',32,0,0,'<span class="required">URI*</span>',array('source'=>'especial','apply_funct_js'=>'friendly_url'));
    $this->addColumn('descripcion','text',0,0,0,'Descripción');
    $this->addColumn('orden','order',0,0,0,'Orden');
    $this->addColumn('desde','date',0,0,0,'Desde');
    $this->addColumn('hasta','date',0,0,0,'Hasta');
    $this->addColumn('color','varchar',6,0,0,'Color');
    $this->addColumn('tituloimg','image',0,0,0,'Imagen de titulo',array('sizes'=>'150x150,304x57x1,304x176x1'));
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'usuario'));
    $this->addColumn('na_usuario.nombre','external');
    $this->addColumn('na_usuario.apellido','external');
...
class notaTable extends Table {
  function notaTable() {
    ...
    $this->addColumn('texto','xhtml',0,0,0,'<span class="required">Texto*</span>',array('style'=>'width:600px;height:300px;'));
    $this->addColumn('claves','varchar',255,0,0,'Etiquetas',array('autocomplete'=>true,'autocomplete_tb'=>'clave'));
    $this->addColumn('estado','varchar',1,0,0,'Estado',array('arr_values'=>array('P'=>'Publicad@','D'=>'Borrador','R'=>'Pendiente a Revisión')));
    $this->addColumn('orden','int',0,0,0,'Orden');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'na_usuario.usuario'));
    $this->addColumn('na_usuario.nombre','external');
...
class comentarionotaTable extends Table {
  function comentarionotaTable() {
    ...
    #$this->addColumn('idnota','int',0,0,'nota','Nota',array('readonly'=>true));
    $this->addColumn('nombre','varchar',50,0,0,'Nombre');
    $this->addColumn('email','varchar',50,0,0,'Email');
    $this->addColumn('web','varchar',300,0,0,'Página Web');
...
class seccionTable extends Table {
  function seccionTable() {
    ...
    $this->addColumn('uri','varchar',32,0,0,'<span class="required">URI*</span>',array('source'=>'seccion','apply_funct_js'=>'friendly_url'));
...
class edicionTable extends Table {
  function edicionTable() {
    ...
    $this->addColumn('estado','char',1,0,0,'Estado',array('arr_values'=>array('A'=>'Publicad@','D'=>'Borrador','P'=>'Pendiente a Revisión','R'=>'Pre-Publicacion')));
    $this->addColumn('numero','int',0,0,0,'Edición No.');
    $this->addColumn('portada','image',0,0,0,'<span class="required">Portada*</span>',array('sizes'=>'245x113x1,150x150x1,109x110x1,70x110x1'));
...
class noticiaTable extends Table {
  function noticiaTable() {
    ...
    $this->maxrows = 10;
    $this->detail = 'credito';
    $this->cache = array(strftime("%Y|%m|%d",strtotime($_SESSION['edicion']['edicion'])) . '|noticia-[uri]-', strftime("%Y|%m|%d",strtotime($_SESSION['edicion']['edicion'])) . '|comentarios|');
    $this->addColumn('idnoticia','serial',0,1,0,'Id');
    if ( ADMIN !== true )
    $this->addColumn('idedicion','auto',0,0,'edicion','Edición',array('default'=>$_SESSION['edicion']['idedicion']));
    else
    $this->addColumn('idedicion','auto',0,0,0,'Edición',array('default'=>$_SESSION['edicion']['idedicion']));
    $this->addColumn('idseccion','int',0,0,'seccion','<span class="required">Sección*</span>');
    ...
    $this->addColumn('ubicacion','char',1,0,0,'Ubicacion',array('arr_values'=>array('D'=>'Derecha','I'=>'Izquierda','R'=>'Recuadro Portada','C'=>'Columna del dia','H'=>'Hablames del Idioma','A'=>'Cartas al Director','E'=>'Editorial')));
    //$this->addColumn('tipo','char',1,0,0,'Tipo',array('arr_values'=>array('D'=>'Columna del dia','H'=>'Hablames del Idioma','C'=>'Cartas al Director','E'=>'Editorial')));
    //$this->addColumn('idregion','int',0,0,'region','Región');
    $this->addColumn('intro','text',0,0,0,'Intro');
    $this->addColumn('resumen','text',0,0,0,'Resumen');
    $this->addColumn('texto','xhtml',0,0,0,'<span class="required">Texto*</span>',array('style'=>'width:700px;height:300px;'));
    ...
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'na_usuario.usuario','readonly'=>true));
    $this->addColumn('na_usuario.nombre','external');
    $this->addColumn('na_usuario.apellido','external');
    $this->addColumn('seccion.uri','external');
    if ( ADMIN !== true ) {
...
class comentarioTable extends Table {
  function comentarioTable() {
    ...
    $this->addColumn('web','varchar',300,0,0,'Página Web');
    $this->addColumn('comentario','text',0,0,0,'Texto');
    $this->addColumn('estado','varchar',0,0,0,'Estado',array('arr_values'=>array('P'=>'en Revisión','B'=>'Bloqueado','A'=>'Aprobado')));
    if ( ADMIN !== true )
    $this->addColumn('idusuario','int',0,0,'usuario','Usuario',array('readonly'=>true));
    #$this->addColumn('razon','text',0,0,0,'Razón Bloqueo');
    $this->addColumn('ip','auto',0,0,0,'IP',array('default'=>$_SERVER['HTTP_X_FORWARDED_FOR']));
    #$this->addColumn('ip','auto',0,0,0,'IP',array('default'=>$_SERVER['REMOTE_ADDR']));
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
...
// {{{ Valoración y Otras Estadísticas
...
// {{{ Encuesta, Marcador y Estadisticas
...
// Opciones de la pregunta de la encuesta
class opcionTable extends Table {
  function opcionTable() {
    ...
    $this->addColumn('idencuesta','int',0,0,'encuesta','Encuesta',array('preset'=>true));
...
class marcadorTable extends Table {
  function marcadorTable() {
    ...
    $this->addColumn('bandera1','image',0,0,0,'Bandera equipo1',array('sizes'=>'55x55,150x150,33x19'));
    $this->addColumn('valor1','varchar',10,0,0,'Puntaje equipo1');
    $this->addColumn('equipo2','varchar',500,0,0,'Equipo2');
    $this->addColumn('bandera2','image',0,0,0,'Bandera equipo2',array('sizes'=>'55x55,150x150,33x19'));
    $this->addColumn('valor2','varchar',10,0,0,'Puntaje equipo2');
    $this->addColumn('fecha','date',0,0,0,'Fecha');
    $this->addColumn('activo','bool',0,0,0,'Activo');
    $this->addColumn('fondo','image',0,0,0,'Fondo',array('sizes'=>'55x55,150x150,298x121'));
...
class paisTable extends Table {
  function paisTable() {
    ...
    $this->addColumn('bandera','image',0,0,0,'Bandera',array('sizes'=>'17x9'));
    $this->addColumn('orden','order',0,0,0,'Orden');
    $this->addColumn('usuario','auth_user',0,0,0,'Creado por:');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
  }
...
class dolarpaisTable extends Table {
  function dolarpaisTable() {
    ...
    # Mostramos solo las noticias de la edición
    #$this->filter = 'dolarpais.idedicion = ' . $_SESSION['edicion']['idedicion'];
    #
    $this->maxrows = 10;
...
class carteleraTable extends Table {
  function carteleraTable() {
    ...
    $this->addColumn('cartelera','image',0,0,0,'Imagen para portada',array('sizes'=>'150x150,390x272x1,370x258x1,544x220x1'));
    $this->addColumn('original','image',0,0,0,'Imagen original',array('sizes'=>'150x150,640x200x1,600x400,397x200x1'));
...
class signoTable extends Table {
  function signoTable() {
    ...
    $this->addColumn('imagen','image',0,0,0,'Imagen',array('sizes'=>'55x55,150x150'));
...
class paginaTable extends Table {
  function paginaTable() {
    ...
    $this->maxrows = 20;
    $this->order = 'uri';
    $this->cache = array("pages|[uri]");
    $this->addColumn('idpagina','serial',0,1,0,'Id');
    $this->addColumn('pagina','varchar',500,0,0,'<span class="required">Titulo*</span>');
    $this->addColumn('uri','varchar',32,1,0,'<span class="required">Id/URI*</span>',array('source'=>'pagina','apply_funct_js'=>'friendly_url'));
    $this->addColumn('texto','xhtml',0,0,0,'<span class="required">Texto*</span>');
    $this->addColumn('estado','char',1,0,0,'Estado');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'usuario'));
...
class anuncioTable extends Table {
	function anuncioTable() {
		...
		$this->addColumn('posicion','int',0,0,0,'Ubicacion',array('arr_values'=>array(1=>'LandScape arriba')));
...
class caricaturaTable extends Table {
  function caricaturaTable() {
    ...
    $this->addColumn('idedicion','auto',0,0,'edicion','Edición',array('default'=>$_SESSION['edicion']['idedicion']));
    $this->addColumn('caricatura','image',0,0,0,'Caricatura',array('sizes'=>'150x150,390x272x1,404,600x450,650x470'));
...
class clasificadoTable extends Table {
  function clasificadoTable() {
    ...
    $this->addColumn('claves','varchar',255,0,0,'Etiquetas',array('autocomplete'=>true,'autocomplete_tb'=>'clave'));
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idca_usuario','int',0,0,'ca_usuario','Usuario',array('display'=>'ca_usuario.ca_usuario'));
...
class imagen_clasificadoTable extends Table {
  function imagen_clasificadoTable() {
    ...
    $this->addColumn('descripcion','text',0,0,0,'Descripcion');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idca_usuario','int',0,0,'ca_usuario','Usuario Publico',array('display'=>'ca_usuario.ca_usuario'));
    $this->addColumn('ca_usuario.nombre','external');
    $this->addColumn('ca_usuario.apellido','external');
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario Administrativo',array('display'=>'na_usuario.usuario'));
    $this->addColumn('na_usuario.nombre','external');
    $this->addColumn('na_usuario.apellido','external');
  }
}
...
class suscriptorTable extends Table {
  function suscriptorTable() {
    ...
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:'); 
    $this->addColumn('idnausuario','int',0,0,'na_usuario','Usuario',array('display'=>'na_usuario.usuario'));
  }
}
...
class poradentroTable extends Table {
  function poradentroTable() {
    ...
    $this->addColumn('enlace','varchar',500,0,0,'Enlace');
    $this->addColumn('idimagen','int',0,0,'imagen','Imagen',array('readonly'=>true));
    $this->addColumn('estado','char',1,0,0,'Estado');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:'); 
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'na_usuario.usuario'));
    $this->addColumn('na_usuario.nombre','external');
...
class infografiaTable extends Table {
  function infografiaTable() {
    ...
    $this->addColumn('imagen','image',0,0,0,'Imagen',array('sizes'=>'200x200'));
    $this->addColumn('estado','char',1,0,0,'Estado');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:'); 
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'na_usuario.usuario'));
    $this->addColumn('na_usuario.nombre','external');
...
class secciondomingoTable extends Table {
  function secciondomingoTable() {
    ...
    $this->addColumn('orden','order',0,0,0,'Orden');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','auto',0,0,'na_usuario','Usuario',array('default'=>$_SESSION['usuario']['idusuario'],'display'=>'usuario'));
    $this->addColumn('na_usuario.nombre','external');
    $this->addColumn('na_usuario.apellido','external');
  }
}
class seccionxdomingoTable extends Table {
  function seccionxdomingoTable() {
    ...
    $this->cache = array('domingo|' . strftime("%Y%m%d",strtotime($_SESSION['edicion']['edicion'])));
    $this->addColumn('idseccionxdomingo','serial',0,1,0,'Id');
    $this->addColumn('iddomingo','auto',0,0,'domingo','Domingo',array('default'=>$_SESSION['edicion']['domingo']['iddomingo']));
...
class paginaxdomingoTable extends Table {
  function paginaxdomingoTable() {
    ...
    $this->addColumn('iddomingo','auto',0,0,'domingo','Domingo',array('default'=>$_SESSION['edicion']['domingo']['iddomingo']));
    $this->addColumn('paginaxdomingo','image',0,0,0,'Página',array('sizes'=>'48x48x1,150x150,448x490,1275x1394x1','paths'=>',,/../public_html/domingo/pages/' . $_REQUEST['iddomingo'] . ',/../public_html/domingo/pages/' . $_REQUEST['iddomingo'] . '/large'));
    $this->addColumn('orden','order',0,0,0,'Orden');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','auto',0,0,'na_usuario','Usuario',array('default'=>$_SESSION['usuario']['idusuario'],'display'=>'usuario'));
    $this->addColumn('na_usuario.nombre','external');
...
class magazineTable extends Table {
  function magazineTable() {
    ...
    $this->addColumn('preview','image',0,0,0,'Preview',array('sizes'=>'228'));
...
class paginaxmagazineTable extends Table {
  function paginaxmagazineTable() {
    ...
    $this->addColumn('idmagazine','int',0,0,'magazine','Magazine');
    $this->addColumn('paginaxmagazine','image',0,0,0,'Página',array('sizes'=>'48x48x1,150x150,371x490,1100x1452x1','paths'=>',,/../public_html/magazine/animada/pages/' . str_replace('-','',$_REQUEST['magazine']) . ',/../public_html/magazine/animada/pages/' . str_replace('-','',$_REQUEST['magazine']) . '/large'));
    $this->addColumn('orden','order',0,0,0,'Orden');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','auto',0,0,'na_usuario','Usuario',array('default'=>$_SESSION['usuario']['idusuario'],'display'=>'usuario'));
    $this->addColumn('na_usuario.nombre','external');
...
# definicion de tablas para Mi Noticia
class minoticiaTable extends Table {
  function minoticiaTable() {
    ...
    $this->cache = array('minoticia|portada|', 'minoticia|comentarios', 'minoticia|minoticia');
    $this->addColumn('idminoticia','serial',0,1,0,'Id');
    $this->addColumn('idseccion','int',0,0,'seccion','<span class="required">Sección*</span>');
    $this->addColumn('antetitulo','varchar',100,0,0,'Antetitulo');
    $this->addColumn('minoticia','varchar',255,0,0,'<span class="required">Titulo*</span>');
    $this->addColumn('subtitulo','varchar',100,0,0,'Subtitulo');
    $this->addColumn('ubicacion','char',1,0,0,'Ubicacion',array('arr_values'=>array('L'=>'Izquierda','M'=>'Centro','S'=>'Slide','C'=>'Columna del dia')));
    //$this->addColumn('tipo','char',1,0,0,'Tipo',array('arr_values'=>array('D'=>'Columna del dia','H'=>'Hablames del Idioma','C'=>'Cartas al Director','E'=>'Editorial')));
    #$this->addColumn('idregion','int',0,0,'region','Región');
    $this->addColumn('intro','text',0,0,0,'Intro');
    $this->addColumn('resumen','text',0,0,0,'Resumen');
...
class galeriaminoticiaTable extends Table {
  function galeriaminoticiaTable() {
    ...
    $this->cache = array('minoticia|galeriasminoticia');
    ...
    $this->addColumn('descripcion','text',0,0,0,'Descripción');
    $this->addColumn('claves','varchar',255,0,0,'Etiquetas',array('autocomplete'=>true,'autocomplete_tb'=>'clave'));
    $this->addColumn('idusuario','int',0,0,'usuario','Usuario',array('display'=>'usuario'));
    ...
    $this->addColumn('estado','varchar',0,0,0,'Estado',array('arr_values'=>array('A'=>'Publicad@','D'=>'Borrador','P'=>'Pendiente a Revisión')));
    $this->addColumn('(SELECT count(idcomentariogaleria) FROM comentariogaleria WHERE idgaleriaminoticia=galeriaminoticia.idgaleriaminoticia AND estado=\'A\') AS comentarios','external');
    $this->addColumn('raiting_1','auto',0,0,0,'Raiting 1');
    $this->addColumn('raiting_2','auto',0,0,0,'Raiting 2');
    $this->addColumn('raiting_3','auto',0,0,0,'Raiting 3');
...
class fotominoticiaTable extends Table {
  function fotominoticiaTable() {
    ...
    $this->addColumn('idminoticia', 'int', 0, 0,'minoticia','Mi Noticia');
    //$this->addColumn('idseccion','int',0,0,'seccion','<span class="required">Sección*</span>');
    $this->addColumn('fotominoticia','image',0,0,0,'<span class="required">Imagen</span>',array('sizes'=>'640x200x1,640x300x1,600x400,397x200x1,360x200x1,300x100x1,360x122x1,271x165x1,270x280x1,397x122x1,288x318,232x155,150x100x1,138x90,120x90x1, 155x180x1, 150x150x1,77x77x1,53x82x1,48x48x1'));
    $this->addColumn('texto','text',0,0,0,'Texto');
...
class videominoticiaTable extends Table {
  function videominoticiaTable() {
    ...
    $this->maxrows = 30;
    $this->cache = array('minoticia|videos');
...
class comentarioojociudadanoTable extends Table {
  function comentarioojociudadanoTable() {
    ...
    $this->addColumn('estado','char',1,0,0,'Estado',array('arr_values'=>array('P'=>'en Revisión','B'=>'Bloqueado','A'=>'Aprobdo')));
    $this->addColumn('idusuario','int',0,0,'usuario','Usuario',array('readonly'=>true));
    $this->addColumn('ip','auto',0,0,0,'IP',array('default'=>$_SERVER['REMOTE_ADDR']));
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('(SELECT count(idcomentarioojociudadano) FROM comentarioojociudadano WHERE idojociudadano=ojociudadano.idojociudadano AND estado=\'A\') AS comentarios','external');
...
# Agregados para la seccion Cocinando con La Prensa
...
class clipcocinandoTable extends Table {
  function clipcocinandoTable() {
    ...
    $this->addColumn('texto','xhtml',0,0,0,'<span class="required">Texto*</span>');
    $this->addColumn('preview','image',0,0,0,'Vista previa',array('sizes'=>'122x92'));
...
class itemTable extends Table {
  function itemTable() {
    ...
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('imagen','image',0,0,0,'Imagen',array('sizes'=>'122x92,60x87,250x330'));
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'usuario'));
    $this->addColumn('na_usuario.nombre','external');
    $this->addColumn('na_usuario.apellido','external');
  }
...
class coleccion_itemTable extends Table {
  function coleccion_itemTable() {
    ...
    $this->addColumn('descripcion','text',0,0,0,'Descripcion');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('imagen','image',0,0,0,'Imagen',array('sizes'=>'122x92,866x354'));
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario',array('display'=>'usuario'));
    $this->addColumn('na_usuario.nombre','external');
    $this->addColumn('na_usuario.apellido','external');
  }
...
class ppoliticoTable extends Table {
  function ppoliticoTable() {
    ...
    $this->addColumn('orden','int',0,0,0,'Orden');
    $this->addColumn('texto','xhtml',0,0,0,'Texto');
    $this->addColumn('imagen','image',0,0,0,'Imagen',array('sizes'=>'90x65,270x195'));
    $this->addColumn('foto','image',0,0,0,'Foto',array('sizes'=>'90x65,270x195'));
...
class paginaxsuplementocomercialTable extends Table {
  function paginaxsuplementocomercialTable() {
    ...
    $this->order = 'orden';    $this->title = 'Paginas';
    $this->maxrows = 5;
    ...
    $this->addColumn('paginaxsuplementocomercial','image',0,0,0,'Página',array('sizes'=>'48x48x1,150x150,371x490,1100x2140,1100x1452','paths'=>',,/../public_html/suplementocomercial/pages/' . str_replace('-','',$_REQUEST['suplementocomercial']) . ',/../public_html/suplementocomercial/pages/' . str_replace('-','',$_REQUEST['suplementocomercial']) . '/large'));
    $this->addColumn('orden','order',0,0,0,'Orden');
    $this->addColumn('creacion','auto',0,0,0,'Fecha Creación:');
    $this->addColumn('idusuario','auto',0,0,'na_usuario','Usuario',array('default'=>$_SESSION['usuario']['idusuario'],'display'=>'usuario'));
    $this->addColumn('na_usuario.nombre','external');
...
class encuestapicTable extends Table {
  function encuestapicTable(){
    ...
    $this->addColumn('idusuario','int',0,0,'na_usuario','Usuario', array('default'=>$_SESSION['usuario']['idusuario'],'display'=>'usuario'));
    $this->addColumn('na_usuario.nombre','external');
    $this->addColumn('na_usuario.apellido','external');
  }
}
...
class opcionespicTable extends Table {
  function opcionespicTable() {
    ...
    $this->addColumn('opcionespic','image',0,0,0,'Foto',array('sizes'=>'640x200x1,640x300x1,600x400,397x200x1,300x100x1,360x122x1,271x165x1,270x280x1,397x122x1,288x318,232x155,150x100x1,138x90,120x90x1,150x150x1,77x77x1,53x82x1,48x48x1,1024x1024'));
