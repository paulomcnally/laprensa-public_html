...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'logogallo',
                type: 'image',
                rect: ['16px', '1120px','130px','81px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"logogallo.png",'0px','0px']
            },
            {
                id: 'logoprensa',
                type: 'image',
                rect: ['525px', '1153px','191px','60px','auto', 'auto'],
            ...
            },
            {
                id: 'Group3',
                type: 'group',
                rect: ['251', '760','222px','24','auto', 'auto'],
                cursor: ['default'],
                c: [
                {
                    id: 'Group2',
    ...
    states: {
        "Base State": {
            ...
            "${_RoundRect}": [
                ["color", "background-color", 'rgba(241,232,39,0.66)'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid13", tween: [ "style", "${_camara2}", "top", '123px', { fromValue: '61px'}], position: 227, duration: 227 },
